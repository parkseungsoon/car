...
<head>
    ...
    <!--  LOG corp Web Analitics & Live Chat  START -->
        ...
        function logCorpAScript_full(){
            ...
            LOGSID = "62bf295cd694703597f047267128bd61";/*logsid*/
            LOGREF = "https%3A%2F%2Fsearch.naver.com%2Fsearch.naver%3Fsm%3Dtab_hty.top%26where%3Dnexearch%26query%3D%25EA%25B2%25AC%25EC%25A0%2581%25EC%25B9%25B4%26oquery%3D%25EC%258D%25A8%25EB%258B%2588%25EC%25B9%25B4%26tqi%3DismZWwp0JXVssm6%252F5CwssssssNw-398034";/*logref*/
...
<header>
    ...
    <nav class="main_nav hide_720 min_w_1200">
        <div class="container over_h">
            <a href="/index.php"><h1 class="float_l">견적카</h1></a>
            <ul class="float_r over_h ">
                ...
                <li class="float_l pad_r_0"><a href="/sub/company.php">견적카</a></li>
            </ul>
        </div>
    </nav>
    ...
    <section class="min_w_1200">
        <div class="sell_banner estimate_banner money_banner container over_h">
            <div class="float_l sell_banner_title ko_font hide_720">
                <h3 class="">차량과 관련된</h3><br><h3 class="">금융상담!</h3>
                <h2>할부 금융 상담서비스</h2>
            </div>
            <div class="float_l sell_banner_title ko_font show_720 hide">
                <h3 class="">차량과 관련된 금융상담!</h3>
                <h2>할부 금융 상담서비스</h2>
            </div>
        </div>
    </section>
    ...
    <footer class="min_w_1200">
        <div class="top_footer">
			...
			<a class="hide show_720 pc_btn" href="/index.php"><h1 class="">견적카</h1></a>
        </div>
        <div class="bottom_footer container over_h">
            <h1 class="float_l hide_720">내차견적 견적카</h1>
            <p class="hide_720">주소 : 인천광역시 남구 경인로 82, 1001호 | 상호 : 해원에이디 | 대표 : 최진호 | 사업자등록번호 : 455-29-00292 | 개인정보관리책임자 : 최진호<br>
                자동차관사업등록증 명칭 : 써니카 | 성명 : 박정호 | 주소 : 인천광역시 남동구 청능대로718번길 7, 106동 1203호<BR>
            고객센터 : 1522-9907 | 팩스 : 1522-9908 | 이메일 : sellcar114@naver.com	Copyright ⓒ By 해원에이디. All Rights Reserved.</p>
			<p class="show_720 hide">주소 : 인천광역시 남구 경인로 82, 1001호 | 상호 : 해원에이디 | 대표 : 최진호 <br> 사업자등록번호 : 455-29-00292 | 개인정보관리책임자 : 최진호<br>고객센터 : 1522-9907 | 팩스 : 1522-9908 <br>이메일 : sellcar114@naver.com<br>Copyright ⓒ By 해원에이디. All Rights Reserved.</p>
        </div>
